package emsi.ma.springmvc2.sec;


import emsi.ma.springmvc2.sec.service.UserDetailsServiceImpl;
...
public class  SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        System.out.println("mdp : "+encodedPWD);
...
/*
        ...
        auth.jdbcAuthentication()
                ...
                .authoritiesByUsernameQuery("select username as principal, role as user_roles from roles where username=?")
                .rolePrefix("ROLE_")
